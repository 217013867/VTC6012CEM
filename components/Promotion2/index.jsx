                ...
                <div className="overlap-group5-2">
                    <div className="group-container-2">
                        <div className="overlap-group1-4">
                            <img className="mask-group-2" src="/img/mg2.svg "/>
                            <img className="x1-3" src={x1}/>
                            <div className="content1-2">
                                <div className="promotion-turbojet1 valign-text-bottom">{promotionturbojet}</div>
                                <div
                                    className="x295-round-trip-economy-class-1 valign-text-bottom poppins-medium-mine-shaft-24px">
                                    {x295RoundTripEconomyClass}
                                </div>
                                <div className="surname-5 valign-text-bottom  poppins-normal-mine-shaft-20px">{surname1}
                                </div>
                            </div>
                        </div>
                        <Link to="/contact-us">
