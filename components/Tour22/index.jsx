                    ...
                    <div className="flex-row-39">
                        ...
                        <div className="overlap-group2-7">
                            <div className="navbar-11">
                                <Link to="/home-page">
                                    <div
                                        className="navbar-link-place-22 poppins-normal-black-16px">{navbarLinkPlace1}</div>
                                </Link>
                                <Link to="/about-us">
                                    <div
                                        className="navbar-link-about-us-11 poppins-normal-black-16px">{navbarLinkAboutUs}</div>
                                </Link>
                                <Link to="/tour">
                                    <div
                                        className="navbar-link-place-23 poppins-normal-red-16px">{navbarLinkPlace2}</div>
                                </Link>
                                <Link to="/promotion-1">
                ...
                <div className="group-tour-2">
                    <div className="overlap-group1-11">
                        ...
                        <Table
                            ...
                            row={tableProps.row}
                        />
                        <Gallery className={galleryProps.className} photos={photos}/>
                    ...
                    <div className="button-default-container-2">
                        <ButtonDefault
                            to={buttonDefault1Props.to}
                            className={buttonDefault1Props.className}
                            to={'/contact-us'}>{buttonDefault1Props.children}</ButtonDefault>
                        <ButtonDefault
                            action={buttonDefault2Props.action}
                            className={buttonDefault2Props.className}
                            action={'back'}>{buttonDefault2Props.children}</ButtonDefault>
                        <ButtonDefault
                            action={buttonDefault3Props.action}
                            className={buttonDefault3Props.className}
                            action={'top'}>{buttonDefault3Props.children}</ButtonDefault>
                    </div>
                </div>
